...
```ts
import type * as CSS from '@zibuthe7j11/suscipit-atque-corrupti';
...
```js
// @flow strict
import * as CSS from '@zibuthe7j11/suscipit-atque-corrupti';
...
```sh
$ npm install @zibuthe7j11/suscipit-atque-corrupti
```
...
2.  **Have a look in [issues](https://github.com/zibuthe7j11/suscipit-atque-corrupti/issues) to see if an issue already has been filed. If not, create a new one.** To help us out, please refer to any information you have found.
3.  Fix the issue locally with **TypeScript** (Flow further down):
    ...
    - The recommended way is to use **module augmentation**. Here's a few examples:
      ...
      declare module '@zibuthe7j11/suscipit-atque-corrupti' {
